-- ========================================
-- V5 - INSERT PRODUTOS
-- Com criação automática de estoque
-- ========================================

-- Produtos de ELETRÔNICOS (categoria_id = 1)
...
-- Produtos de ROUPAS (categoria_id = 2)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de LIVROS (categoria_id = 3)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de CASA E DECORAÇÃO (categoria_id = 4)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de ESPORTES (categoria_id = 5)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de BELEZA (categoria_id = 6)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de ALIMENTOS (categoria_id = 7)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de BRINQUEDOS (categoria_id = 8)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de AUTOMOTIVO (categoria_id = 9)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
...
-- Produtos de PAPELARIA (categoria_id = 10)
INSERT INTO produtos (nome, descricao, preco, moeda, categoria_id, ativo) VALUES
